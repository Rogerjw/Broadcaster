...
describe('Api endpoints', () => {
  ...
  it('should be able to update the location of a specific redflag', (done) => {
    ...
    chai.request(server)
      .patch('/api/v1/redflags/2/location')
      .set('token', genToken)
      .send(redflag)
      .end((error, res) => {
        res.status.should.be.equal(200);
  ...
  it('should be not able to update the location of a not found redflag', (done) => {
    chai.request(server)
      .patch('/api/v1/redflags/6/location')
      .set('token', genToken)
      .end((error, res) => {
        res.status.should.be.equal(404);
      });
  ...
  it('should be able to update the comment of a specific redflag', (done) => {
    ...
    chai.request(server)
      .patch('/api/v1/redflags/2/comment')
      .set('token', genToken)
      .send(redflag)
      .end((error, res) => {
        res.status.should.be.equal(200);
  ...
  it('should be not able to update the comment of a not found redflag', (done) => {
    chai.request(server)
      .patch('/api/v1/redflags/6/comment')
      .set('token', genToken)
      .end((error, res) => {
        res.status.should.be.equal(404);
      });
